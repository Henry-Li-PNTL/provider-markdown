...
xpkg.build.provider-pntl: do.build.images
...
dev: $(KIND) $(KUBECTL)
	...
	@$(INFO) Installing Provider PNTL CRDs
	@$(KUBECTL) apply -R -f package/crds
	@$(INFO) Starting Provider PNTL controllers
...
# This target prepares repo for your provider by replacing all "pntl"
